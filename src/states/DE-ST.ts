  ...
  const plots = parzellen.reduce((acc, p) => {
    ...
    acc.push(
      new Field({
        ...
        PartOfField: 0,
        SpatialData: toGeoJSON(hnf["fa:geometrie"], "EPSG:25832"),
        LandUseRestriction: "",
        Cultivation: {
          PrimaryCrop: {
